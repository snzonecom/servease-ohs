...
@Component({
  selector: 'app-rate-customers',
  templateUrl: './rate-customers.component.html',
  styleUrl: './rate-customers.component.css'
})
export class RateCustomersComponent implements OnInit {
